    ...
    <>
      <div className="overflow-x-hidden">
        ...
        <section className="bg-secondary relative pt-[153px] pb-[55px] lg:pb-40 flex flex-col md:flex-row items-center">
          <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:block">
              <Image
                className="absolute top-0 xl:pt-[3px] right-0 md:max-w-[420px] lg:max-w-[570px] xl:max-w-[650px] 2xl:max-w-[initial]"
                data-aos="fade-left"
                src="/assets/images/waleed-bhai.png" // Ensure this path is correct
                alt="icon"
                layout="responsive" // Next.js specific prop for responsiveness
                width={600} // Adjust width and height as per your image size
                height={870}
              />
            ...
            >
              <div className="col-span-12 lg:col-span-6 xl:col-span-6">
                <div className="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2">
                  ...
                  <h3 className="ml-7 mr-7 text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px] relative before:rounded-full before:bg-primary before:block before:absolute before:top-[2px] before:left-0 before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[60px] before:h-[36px] lg:before:h-[48px] xl:before:h-[60px]">
                    My specialties
                  </h3>
                </div>
              </div>
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              >
                <div className="px-6 py-9 bg-black-800 rounded-lg flex flex-wrap flex-col justify-between max-w-[416px] mx-auto h-full group">
                  <div className="flex flex-wrap justify-end relative xl:mr-4">
                    <a
                      href="contact.html"
        ...
        <section className="bg-white py-[120px] testimonial" data-aos="fade-up">
          <div className="pr-15 m-5 xl:pr-0 xl:pl-[4%] 2xl:pl-[6%] 3xl:pl-[17%]">
            <div className="pr-5 flex flex-col  xl:flex-row gap-x-[75 px] 2xl:gap-x-[100px] 3xl:gap-x-[165px]">
              <div className="font-bold font-Syne leading-none flex flex-wrap flex-col gap-y-2 md:text-center xl:text-left mb-10">
                ...
                <h3 className="inline-block text-black-800 text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                  ...
                  ient
                  <br className="hidden xl:inline-block" /> feedback
                </h3>
              </div>

              <div className="swiper w-full flex-row gap-x-[8px]">
                <div className="swiper-wrapper flex gap-x-[10px]">
