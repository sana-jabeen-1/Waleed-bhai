...
const Footer = () => {
  return (
    <div>
      <footer className="footer bg-black-800 pt-[12px] lg:pt-[100px] xl:pt-[120px] pb-[75px]">
        <div className="container pr-9 pl-0 mr-3">
          <div className="overflow-x-hidden" data-aos="flip-down">
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6 selection:">
              <div className="pt-12">
                <h3 className="text-white font-Syne font-bold text-4xl lg:text-5xl xl:text-[64px] tracking-[-1.5px]">
                  <span className="text-black relative z-[1] before:rounded-full before:bg-primary before:block before:absolute before:top-[8px] before:left-[0] before:-z-[1] before:w-[36px] lg:before:w-[48px] xl:before:w-[60px] before:h-[36px] lg:before:h-[48px] xl:before:h-[60px]">
                    Le
                  </span>
                  t’s work together
                </h3>
              ...
              <div className="py-9 px-7 border-border-white border rounded-2xl flex flex-col justify-between group">
                ...
                <div className="flex justify-between items-center">
                  <p className="text-2xl font-bold font-Syne leading-none text-orange">
            ...
            <div className="grid grid-cols-1 gap-6 p-12">
              <Image
                data-aos="zoom-in"
                src="/assets/images/footer-name.png" // Ensure this path is correct
                alt="icon"
                width={1281} // Set appropriate width
                height={77} // Set appropriate height
              />
            </div>
